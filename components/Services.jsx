...
function Services() {
  return (
    <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <h2 className="text-center text-5xl fonto-Ovo">My Services</h2>
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        I am a afornt thata dveeloper ehsnsk ksab akjsamn asbkjbsam ask sasa
        sasvsa sa jhsa sa hassa sajas sajhsa as sajh sajh sahjsa jhas bas assajh
      </p>
