...
export const serviceData = [
  {
    ...
    description:
      "Building and maintaining websites with robust functionality and responsive design.",
    link: "",
  },
  {
    icon: assets.mobile,
    ...
    description:
      "Creating software applications for smartphones and tablets with seamless performance.",
    link: "",
  },
  {
    ...
    title: "Data Analysis",
    description:
      "Collecting, cleaning, and analyzing data to uncover insights and support decision-making.",
    link: "",
  },
  {
